...
TextVar = StringVar()
TextBox = Entry(Screen,width=80,textvariable=TextVar).grid(row=2,column = 1,ipady=280,ipadx=50)

Label(Screen,text="Output Text").grid(row=2,column =2)
OutputVar = StringVar()
TextBox = Entry(Screen,width=80,textvariable=OutputVar).grid(row=2,column = 3,ipady=280,ipadx=50)
